                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-5 chocolate-sidebar d-flex flex-column align-items-center justify-content-center p-4 text-center position-relative">
                        <div class="position-relative z-index-1">
                            ...
                            <p>Entra nel mondo del cioccolato artigianale più pregiato e scopri un'esperienza di gusto unica.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-7 bg-white p-5">
                        ...
                        <form>
                            ...
                            <div class="text-center">
                                ...
                                <p class="mt-3">Non hai un account? <a href="register.php" class="chocolate-link">Registrati ora</a></p>
                            </div>
